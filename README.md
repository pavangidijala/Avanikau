...
A funny/savage AI chatbot website powered by Groq's free API, replies in Telugu.
...
- The model used is `openai/gpt-oss-120b` (fast + free on Groq, replaces the now-deprecated llama-3.3-70b-versatile). You can swap it for another Groq model name in `api/chat.js` if you want.
